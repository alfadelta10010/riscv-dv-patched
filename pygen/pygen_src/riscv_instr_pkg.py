...
class privileged_reg_t(IntEnum):
    ...
    PMPADDR16 = 0x3C0  # Physical memory protection address register (SV src has 'h4C0; priv spec is 0x3C0)
    ...
    PMPADDR32 = 0x3D0  # Physical memory protection address register (SV src has 'h4D0; priv spec is 0x3D0)
    ...
    PMPADDR48 = 0x3E0  # Physical memory protection address register (SV src has 'h4E0; priv spec is 0x3E0)
    ...
    SCONTEXT = 0x5A8  # Supervisor mode trigger context register
